...
<div id="container">
	 ...
	 <?php echo $this->session->userdata('userlevel_name');?></div>
        ...
        <div id="right">
         <div class="content">
            <div id="head"><p>View Faculty Record/s</p></div>
            <br>
           <?php
...
foreach ($school_year as $row){
 ...
 $assigned = array();
    $count = 1;
    $assigned[0] = "All Records";
    foreach($assigned_program as $row){
      $assigned[$count] = $row->program_name;
      $count++;
    }
    
echo "Program: ".form_dropdown('program', $assigned).br(2);
