...
if($report_data != NULL){
    ...
    foreach($keywords as $column){
     ...
     echo "<div class='pos3'>".anchor('index.php/rpc/loadprintassigned/'.$val.'/'.$report_data[0]['program_id'].'/'.$report_data[0]['SY_id'],"<p class='print'></p>")."</div>"; //export to pdf
	 }
   }//end foreach column
}
