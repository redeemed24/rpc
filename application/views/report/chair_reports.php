...
echo "Program: ".form_dropdown('program', $program_list)."&nbsp&nbsp&nbsp".br(2);
        
echo "Name: ";
        $opt1='';
        $opt = 'placeholder="Enter Last/First Name"';
echo form_input('keywords',$opt1,$opt)."&nbsp";
...
if($report_data != NULL){
    ...
    foreach($keywords as $column){
     ...
     echo "<div class='pos3'>".anchor('index.php/rpc/loadprintallreports/'.$val.'/'.$report_data[0]['program_id'].'/'.$report_data[0]['SY_id'],"<p class='print'></p>")."</div>"; //export to pdf
	 }
   }//end foreach column
}
