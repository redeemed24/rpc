...
<div id="container">
	...
	echo "Userlevel: ".form_dropdown('userlevel', $userlevel)."&nbsp";
        echo "Name: ";
        $opt1='';
        $opt = 'placeholder="Enter Last/First/User Name"';
...
//Displays all users in tabular format
        ...
        if($allusers_data == NULL){
                ...
                echo "<th class='status'>"."&nbsp Action &nbsp"."</th>";
                echo "</tr>";
                echo "</thead>";
	    ...
	    if($user_info[$count]['user_level']!='Human Resource' && $user_info[$count]['user_level']!='Superuser'){
                echo "<tr>";
    ...
    echo "</tr>";
      }//end if($user_info[$count]['user_level']!='Human Resource')
}
echo "</tbody>";
echo "</table>";
echo "</div>";
